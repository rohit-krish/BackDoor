...
/* 
 * compile this file in windows os
 * if you encounder any error like this => {
 ...
 * }
 * you can use the following command in order to compile it in windows os
 * gcc <filename.c> -o <outputFileName.exe> -lws2_32
 */


/* 
 * if don't have windows then run the following commands in order to compile it in any linux os
 * sudo apt update
